...
def make_con():
    ...
    for file in file_list[0:1]:
        ...
        con, freqs, times, n_epochs, n_tapers = spectral_connectivity(label_ts, method=con_methods, mode='multitaper', sfreq=sfreq, 
            fmin=fmin, fmax=fmax, faverage=True, mt_adaptive=True, n_jobs=1,tmin=tmin,tmax=tmax)
...
connectivity_foulder = r'E:\MIPDB\MIPDB_video_3_connectivity_T'
...
excel_name = connectivity_foulder+r'\MIPDB_video_3_group_connectivity_T.xlsx'
